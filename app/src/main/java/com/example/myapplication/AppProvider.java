...
public class AppProvider extends ContentProvider {
    ...
    // Використовується для розпізнавання URI
    private static final UriMatcher sUriMatcher = buildUriMatcher();

    // Коди для UriMatcher
    public static final int FRIENDS = 100;    // Для всієї таблиці "friends"
    public static final int FRIENDS_ID = 101; // Для одного рядка в "friends"
    ...
    public boolean onCreate() {
        // Ініціалізуємо наш допоміжний клас для роботи з БД
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        if (match == FRIENDS) {
            ...
            if (recordId > 0) {
                // Створюємо URI для нового запису
